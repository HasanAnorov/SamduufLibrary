package com.ierusalem.samduuflibrary.core.ui.theme
...
val MontserratFontFamily = FontFamily(
    ...
    androidx.compose.ui.text.font.Font(resId = R.font.montserrat_regular),
    Font(googleFont = MontserratFont, fontProvider = provider, weight = FontWeight.Light),
    androidx.compose.ui.text.font.Font(resId = R.font.montserrat_light, weight = FontWeight.Light),
...
val KarlaFontFamily = FontFamily(
    ...
    androidx.compose.ui.text.font.Font(resId = R.font.karla_regular),
    Font(googleFont = KarlaFont, fontProvider = provider, weight = FontWeight.Bold),
    androidx.compose.ui.text.font.Font(resId = R.font.karla_bold, weight = FontWeight.Bold),
)
